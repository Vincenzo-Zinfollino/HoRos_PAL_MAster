...
#per creare una griglia piu sparsa utilizzo un diametro fittizio di 8
# ==========================================
# ENTRY POINT
# ==========================================
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generatore offline di celle raggiungibili per ripiani (da World e SDF).")
    parser.add_argument("--world",  default="src/pal_gazebo_worlds/worlds/poliBaMaster.world",help="Percorso del file .world di Gazebo")
    parser.add_argument("--sdf",  default="src/pal_gazebo_worlds/models/reemc_bookshelf/bookshelf.sdf",help="Percorso del file .sdf del modello della libreria")
    parser.add_argument("--model_name", default="s3_bookshelf", help="Nome del modello nel file .world (default: s3_bookshelf)")
    parser.add_argument("--can_diameter", type=float, default=0.08, help="Diametro della lattina in metri (default: 0.065)")
