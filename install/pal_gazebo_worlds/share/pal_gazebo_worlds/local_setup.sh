...
: ${AMENT_CURRENT_PREFIX:="/home/user/exchange/workspace/install/pal_gazebo_worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pal_gazebo_worlds/environment/pal_gazebo_worlds.sh"
