...
: ${AMENT_CURRENT_PREFIX:="/home/user/exchange/workspace/install/tiago_pro_laser_sensors"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_pro_laser_sensors/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_pro_laser_sensors/environment/path.sh"
